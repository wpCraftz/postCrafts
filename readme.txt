...
Contributors: faisalahmed29, wpcraftz
...
2. In the search field type PostCrafts and press enter.
...
- Update: Range component UI/UX
- Update: Excerpt default length

= 0.1.2 - 09 April 2024 =

- Fix: Pagination issue when max page is less than 3
