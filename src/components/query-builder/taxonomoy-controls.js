...
export default function TaxonomyControls( {
	...
	const taxonomies = useTaxonomies( postType )?.filter(
		( taxonomy ) =>
			taxonomy.slug === 'category' || taxonomy.slug === 'post_tag'
	);
					...
					<>
						...
						{ enableRelation && (
							<SelectControl
								...
								options={ [
									{
										label: __( 'IN', 'pc-blocks' ),
										value: 'IN',
									},
									{
										label: __( 'NOT IN', 'pc-blocks' ),
										value: 'NOT IN',
									},
									{
								...
								onChange={ ( newRelation ) =>
									setAttributes(
										taxonomy.slug === 'category'
											? { catOperator: newRelation }
											: { tagOperator: newRelation }
									)
								}
							/>
						) }
